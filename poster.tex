...
\end{minipage}
  ...
  \headerbox{Programming exercises!}{name=exercises,column=0,below=tldr}{
    ...
    \item Automatically-evaluated exercises are useful in introductory
          programming courses\cite{gotelPPPJ2007}\cite{hallJSSC2008}\cite{williamsJSSC2006}
      \BI
...
%          by August 2013
  ...
  \headerbox{Screenshots}{name=screenshot,column=2,span=3}{
    ...
    \vskip .1in
    \centerline{\includegraphics[height=3in]{images/exercise}}
    \end{minipage}
  ...
  \headerbox{Research questions, preliminary data}{name=questions,column=2,span=2,below=screenshot}{
    ...
    and error coding?  Three students completing an exercise:
    \vskip .1in
