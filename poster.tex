...
\end{minipage}
  ...
  \headerbox{Screenshots}{name=screenshot,column=2,span=3}{
    ...
    \vskip .1in
    \centerline{\includegraphics[height=2.7in]{images/menu}}
    \end{minipage}\hskip .1in\begin{minipage}[t]{4in}
    \centerline{\bf\underline{Working on an exercise}}
    \vskip .1in
    \centerline{\includegraphics[height=2.7in]{images/exercise}}
    \end{minipage}
  ...
  \headerbox{Research questions, preliminary data}{name=questions,column=2,span=2,below=screenshot}{
    ...
    \item Can exercises be reused effectively?
      ...
      \EI
    \item Can instructors find appropriate exercises to reuse?
    \EI
    }
    ...
    \item Do we see improved outcomes when students do exercises?
          Exams in CS~101 at York College
...
%  }
  ...
  \headerbox{Get involved!}{name=support,column=4,below=support}{
    ...
    \hfill\centering\begin{tikzpicture}
      \node[checkitout] {\includegraphics[width=5.5cm]{images/checkitout}};
    \end{tikzpicture}
