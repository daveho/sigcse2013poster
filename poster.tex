...
\end{minipage}
  ...
  \headerbox{Screenshots}{name=screenshot,column=2,span=3}{
    ...
    \centerline{\bf Main menu, choosing exercise}
    \vskip .1in
    \includegraphics[width=4.2in]{images/menu}
    \end{minipage}\hskip .4in\begin{minipage}[t]{4.2in}
    \centerline{\bf Working on an exercise}
    \vskip .1in
  ...
  \headerbox{Support}{name=support,column=4,below=screenshot}{
    \vskip .1in
    {\small
