...
%          by August 2013
  ...
  \headerbox{Research questions}{name=questions,column=2,span=2,below=screenshot}{
    ...
    {\raggedright\normalsize
    \BI
    \item Can we detect students who are ``flailing''? (And offer suggestions to help
    them make progress?)  Consider student A:
    \vskip .1in
    \centerline{\includegraphics[width=4in]{images/Comparison}}
    \item Do we see improved outcomes when programming exercises are used?
    \vskip .1in
    \centerline{TODO: data from YCP CS 101}
    \EI
    }
  }
