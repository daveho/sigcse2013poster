...
\end{minipage}
  ...
  \headerbox{Screenshots}{name=screenshot,column=2,span=3}{
    ...
    \centerline{\bf Main menu, choosing an exercise}
    \vskip .1in
  ...
  \headerbox{Future work}{name=futurework,column=4,below=screenshot}{
    \vskip .1in
    \BI
    \item Future work?
    \EI
  ...
  \headerbox{Support}{name=support,column=4,below=futurework}{
    \vskip .1in
    {\small
