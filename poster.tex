...
\end{minipage}
  ...
  \headerbox{Exercise repository}{name=repository,column=1,below=community}{
    ...
    \centerline{\begin{tikzpicture}
      \node[medurl] {\Large\bf https://cloudcoder.org/repo};
    \end{tikzpicture}}
...
%  }
  ...
  \headerbox{Get involved!}{name=support,column=4,below=support}{
    ...
    {\raggedright\normalsize
      ...
      \centerline{\begin{tikzpicture}
          \node[medurl,text width=7cm] {\Large\bf We want to expand our user base for Fall 2013!};
        \end{tikzpicture}}

      \BI
      \item We already have over 100 C/C++ and Java exercises to get you started!
      \item Are your exercises are better than ours!
