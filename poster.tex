...
\tikzstyle{bigurl} = [fill=paleyellow, text=black, rounded corners, inner sep=8pt, inner ysep=6pt]
...
\vskip -.17in\hskip -.05in\usebox{\hcii}}
\end{minipage}
}{
  % University logo(s)
...
%          by August 2013
  ...
  \headerbox{Research questions}{name=questions,column=2,span=2,below=screenshot}{
    ...
    Consider student A:
    \vskip .1in
    \centerline{\includegraphics[width=2.3in]{images/Comparison}}
    ...
    \item Can exercises be reused effectively?
      \BI
      \item In different courses? At different institutions?
      \EI
    \EI
    }
